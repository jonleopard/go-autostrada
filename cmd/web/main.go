...
import (
	...
	"hasherdb/internal/database"
	"hasherdb/internal/smtp"
	"hasherdb/internal/version"
...
func run(logger *slog.Logger) error {
	...
	flag.StringVar(&cfg.cookie.secretKey, "cookie-secret-key", "4rqimst37qpj7gfkatmkk55z4zuqlrrc", "secret key for cookie authentication/encryption")
	...
	flag.StringVar(&cfg.session.secretKey, "session-secret-key", "ds6x2sr5rh42bkbuzapw2agd7wu4riq6", "secret key for session cookie authentication")
